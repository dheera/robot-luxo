...
animation = [
        ...
        {"name": "ankle", "start_time": 4.0, "end_time": 4.5, "start_value": 0.2, "end_value": 0.2, "ease": "inout_quad"},
        {"name": "ass", "start_time": 0.0, "end_time": 0.5, "start_value": 0.7, "end_value": 0.7, "ease": "inout_quad"},
        {"name": "ass", "start_time": 4.0, "end_time": 4.5, "start_value": 0.7, "end_value": 0.7, "ease": "inout_quad"},
        {"name": "neck", "start_time": 0.0, "end_time": 0.5, "start_value": 0.2, "end_value": 0.2, "ease": "inout_quad"},
        {"name": "neck", "start_time": 4.0, "end_time": 4.5, "start_value": 0.2, "end_value": 0.2, "ease": "inout_quad"},
        {"name": "base", "start_time": 0.0, "end_time": 0.5, "start_value": 0.5, "end_value": 0.5, "ease": "linear"},
        {"name": "base", "start_time": 0.5, "end_time": 2.0, "start_value": 0.5, "end_value": 0.1, "ease": "linear"},
        {"name": "base", "start_time": 2.0, "end_time": 5.0, "start_value": 0.1, "end_value": 0.9, "ease": "linear"},
        {"name": "base", "start_time": 5.0, "end_time": 6.0, "start_value": 1.0, "end_value": 0.5, "ease": "linear"},
]
...
m = String()
m.data = json.dumps([animation, animation2]) #, animation2])
time.sleep(0.5)
pub.publish(m)

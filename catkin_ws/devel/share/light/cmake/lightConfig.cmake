...
if("TRUE" STREQUAL "TRUE")
  set(light_SOURCE_PREFIX /home/ubuntu/robot-luxo/catkin_ws/src/light)
  set(light_DEVEL_PREFIX /home/ubuntu/robot-luxo/catkin_ws/devel)
  set(light_INSTALL_PREFIX "")
  set(light_PREFIX ${light_DEVEL_PREFIX})
else()
  set(light_SOURCE_PREFIX "")
  set(light_DEVEL_PREFIX "")
  set(light_INSTALL_PREFIX /opt/ros/noetic)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'light' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'light' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/robot-luxo/catkin_ws/src/light/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT light_NUM_DUMMY_TARGETS)
      set(light_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::light::wrapped-linker-option${light_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR light_NUM_DUMMY_TARGETS "${light_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::light::wrapped-linker-option${light_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND light_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${light_dep}_FOUND)
      find_package(${light_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${light_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(light_EXPORTED_TARGETS ${${light_dep}_EXPORTED_TARGETS})
endforeach()
